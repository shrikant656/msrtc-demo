...
/*---------------------------------------Dropdown---------------------------------------*/
    ...
    angular.module('routerApp').controller('DemoCtrl', function ($scope, $http, $timeout, $interval) {
  var vm = this;
  ...
  vm.countries = [ // Taken from https://gist.github.com/unceus/6501985
    ...
    angular.module('routerApp').controller('MainCtrl', function($scope) {
      ...
      $scope.client.primary_address.country = 'Australia';
...
/*--------------------------------------------Modal----------------------------------------*/
  ...
  $ctrl.open = function (size, parentSelector) {
    ...
    angular.module('routerApp').controller('DemoCtrl', function ($scope, $http, $timeout, $interval) {
      ...
      vm.country.selected = {name: 'Albania', code: 'AL'};
    })
